...
public class MonotoneCubicSpline {
    ...
    public MonotoneCubicSpline(List<Double> x, List<Double> y, Double[] m) {
        mX = x;
        mY = y;
        mM = m;
    }
	...
	public static MonotoneCubicSpline createMonotoneCubicSpline(List<Double> x, List<Double> y) {
